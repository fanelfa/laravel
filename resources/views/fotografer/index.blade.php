    ...
    <div class="col-md-9">
        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <br/>
                <br/>
                <label for="tambah-data"><a href="{{ url('/fotografer/create') }}">Tambah Data Guru</a></label>
                <br/>
                <br/>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('fotografer.edit', ['data'=>Crypt::encrypt($value->id)]) }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> EDIT</a>

                                    <a class="btn btn-danger btn-xs btn-delete" data-file="{{$value->id}}"><i class="fa fa-trash-o"></i> HAPUS</a>

                                    <form action="{{ route('fotografer.destroy', $value->id) }}" method="POST" style="display: none;" id="{{$value->id}}">
